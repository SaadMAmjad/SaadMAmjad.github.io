                ...
                <div className="accordion" id="otherProjectsList">
                    ...
                    <div className="accordion-item bg-dark text-white">
                        <h2 className="accordion-header" id="drawing">
                            <button className="accordion-button bg-dark text-white" type="button" data-bs-toggle="collapse" data-bs-target="#drawingControl" aria-expanded="false" aria-controls="drawingControl">
                    ...
                    {/* <div className="accordion-item bg-dark text-white">
                        <h2 className="accordion-header" id="placeholder">
                            <button className="accordion-button collapsed bg-dark text-white" type="button" data-bs-toggle="collapse" data-bs-target="#placeholderControl" aria-expanded="false" aria-controls="placeholderControl">
                                <strong className='secondaryText'>Game Tracker</strong>
                            </button>
                        </h2>
                        <div id="placeholderControl" className="accordion-collapse collapse" aria-labelledby="placeholder" data-bs-parent="#otherProjectsList">
                            <div className="accordion-body">
